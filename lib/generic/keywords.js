...
exports.TypeKeywordRule = exports.TypeKeywordEnforcer = exports.SequentialKeywordEnforcerFactory = exports.KeywordEnforcerFork = exports.KeywordValueEnforcer = void 0;
...
var SequentialKeywordEnforcerFactory = /** @class */ (function () {
    ...
    SequentialKeywordEnforcerFactory.prototype.process = function (schema, context) {
        ...
        var enforcer = {
            ...
            coerce: (0, coercion_1.mergeCoerceSteps)(coerceQueue),
            enforcers: enforcers
        };
        return enforcer;
    };
